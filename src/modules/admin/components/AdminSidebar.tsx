...
const getColorConfig = (category: string | null) => {
    ...
    if (lower.includes('links')) return {
        activeBg: 'bg-amber-100 dark:bg-amber-900/20',
    ...
    if (lower.includes('analytics') || lower.includes('feedback')) return {
        activeBg: 'bg-rose-100 dark:bg-rose-900/20',
